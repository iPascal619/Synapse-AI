    ...
    >
      ...
      <div className="relative z-10 space-y-4 md:space-y-5 lg:space-y-6 mb-6 md:mb-7 lg:mb-9 max-w-md md:max-w-[500px] lg:max-w-[588px] mt-16 md:mt-[120px] lg:mt-[160px] px-4">
        ...
        <p className="text-muted-foreground text-base md:text-base lg:text-lg font-medium leading-relaxed max-w-lg mx-auto">
          Protect your business with AI-powered fraud detection that identifies suspicious activities in real-time and
          prevents financial losses.
        </p>
        
        {/* Trust Indicators */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-sm text-muted-foreground pt-2">
      ...
      <div className="relative z-10 flex flex-col items-center gap-4">
        <a href="#waitlist-section">
          <Button className="relative z-10 bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-3 rounded-full font-medium text-base shadow-lg ring-1 ring-white/10 group transition-all duration-300">
        ...
        <p className="text-xs text-muted-foreground">
          🚀 Coming Soon • Be the first to experience next-gen fraud protection
        </p>
      </div>
    </section>
  )
