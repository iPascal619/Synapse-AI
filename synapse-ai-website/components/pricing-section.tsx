  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$0",
      annualPrice: "$0",
      description: "Perfect for small businesses starting fraud protection.",
      features: [
    ...
    },
    {
      ...
      monthlyPrice: "$499",
      annualPrice: "$399",
      description: "Comprehensive fraud protection for large organizations.",
      features: [
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          ...
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Get early access with special launch pricing. Choose a fraud protection plan that fits your business size, from small startups to growing companies and large enterprises.
          </p>
        </div>
        <div className="pt-4">
